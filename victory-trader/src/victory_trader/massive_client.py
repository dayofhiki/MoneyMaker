...
class MassiveClient:
    ...
    def short_volume_market(
        ...
        *,
        ...
        """Fetch historical FINRA short-volume records across the market."""
        params: dict[str, Any] = {
            "limit": int(limit),
    ...
    def short_interest(
        ...
        *,
        ...
        """Fetch historical FINRA short-interest position records."""
        params: dict[str, Any] = {
            "ticker": ticker.upper(),
            "limit": int(limit),
    ...
    def splits(
        ...
        *,
        ...
        """Fetch historical split records for one stock ticker."""
        params: dict[str, Any] = {
            "ticker": ticker.upper(),
            "limit": int(limit),
