...
def retention_aware_active_rows_with_state(
...
def _sensitivity_summary(
    ...
    for additions in SENSITIVITY_ADDITIONS:
        active, trace = retention_aware_active_rows_with_state(
            scored,
...
def run_probe(
    ...
    for day in daterange(start, end):
        ...
        primary, primary_trace = retention_aware_active_rows_with_state(scored)
    ...
    primary_gate = bool(
        ...
        < float(baseline_state["sparse_waste_rate"])
    ...
    for additions in SENSITIVITY_ADDITIONS:
        sens_active, sens_trace = retention_aware_active_rows_with_state(
            all_eval_scored,
            max_additions=additions,
        )
